...
function createMotionComponent({ preloadedFeatures: preloadedFeatures2, createVisualElement: createVisualElement2, useRender, useVisualState: useVisualState2, Component: Component2 }) {
  ...
  function MotionComponent(props, externalRef) {
    let MeasureLayout2;
    const configAndProps = __spreadProps(__spreadValues(__spreadValues({}, (0, import_react12.useContext)(MotionConfigContext)), props), {
    ...
    if (!isStatic && isBrowser) {
      ...
      if (context.visualElement) {
        MeasureLayout2 = context.visualElement.loadFeatures(configAndProps, isStrict, preloadedFeatures2, projectionId, initialLayoutGroupConfig);
      }
    }
    return React.createElement(MotionContext.Provider, { value: context }, MeasureLayout2 && context.visualElement ? React.createElement(MeasureLayout2, __spreadValues({ visualElement: context.visualElement }, configAndProps)) : null, useRender(Component2, props, projectionId, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, context.visualElement));
  }
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, projectionId, ref, { latestValues }, isStatic) => {
    ...
    return (0, import_react15.createElement)(Component2, __spreadProps(__spreadValues({}, elementProps), {
...
function MeasureLayout(props) {
  ...
  return import_react18.default.createElement(MeasureLayoutWithContext, __spreadProps(__spreadValues({}, props), { layoutGroup, switchLayoutGroup: (0, import_react18.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove }));
}
...
var VisualElement = class {
  ...
  loadFeatures(_a, isStrict, preloadedFeatures2, projectionId, initialLayoutGroupConfig) {
...
function MotionConfig(_a) {
  ...
  config = __spreadValues(__spreadValues({}, (0, import_react25.useContext)(MotionConfigContext)), config);
...
var LayoutGroup = ({ children, id: id5, inherit = true }) => {
  ...
  const memoizedContext = (0, import_react28.useMemo)(() => __spreadProps(__spreadValues({}, context.current), { forceRender }), [key]);
...
function ReorderGroup(_a, externalRef) {
  ...
  return React8.createElement(Component2, __spreadProps(__spreadValues({}, props), { ref: externalRef, ignoreStrict: true }), React8.createElement(ReorderContext.Provider, { value: context }, children));
}
...
function ReorderItem(_a, externalRef) {
  ...
  return React9.createElement(Component2, __spreadProps(__spreadValues({ drag: axis }, props), { dragSnapToOrigin: true, style: __spreadProps(__spreadValues({}, style), { x: point2.x, y: point2.y, zIndex }), layout: layout2, onDrag: (event, gesturePoint) => {
...
function handoffOptimizedAppearAnimation(id5, name, value, frame2) {
...
function startOptimizedAppearAnimation(element, name, keyframes2, options, onReady) {
  ...
  const readyAnimation = animateStyle(element, name, [keyframes2[0], keyframes2[0]], { duration: 1e4, ease: "linear" });
